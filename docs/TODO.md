...
P1 Frontend: direct q, heatLoss_kW, extrapolation warning.
P1 Validation: literature dataset mapping/report.
P1 DevOps: protected main, CI, staged frontend/backend deploy.
